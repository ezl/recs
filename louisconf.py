...
HOSTS = (
#   ('ip address', 'hostname'),
    ('173.255.225.206', 'recs'),
)


PROJECT_NAME = "recs"
GIT_URL = "https://github.com/ezl/recs.git"
...
# ==================
POSTGRES_USERNAME = "recs"
POSTGRES_PASSWORD = "recs"
POSTGRES_DBNAME = "recs_recs"

APACHE_SERVER_NAME = "*"    # example.com
APACHE_SERVER_ALIAS = "*"   # *.example.com
APACHE_SERVER_ADMIN = "ericzliu@gmail.com"
